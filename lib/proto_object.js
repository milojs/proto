...
function filterKeys(callback, thisArg, onlyEnumerable) {
	var filterResult = {};
	eachKey.call(this, filterProperty, this, onlyEnumerable);
	return filterResult;

	function filterProperty(value, key) {
		var descriptor = Object.getOwnPropertyDescriptor(this, key);
...
function someKey(callback, thisArg, onlyEnumerable) {
	try {
		eachKey.call(this, testProperty, this, onlyEnumerable);
	} catch (test) {
	...
	function testProperty(value, key) {
		if (callback.call(thisArg, value, key, this))
			throw _passed;
	}
}
