...
describe('Prototype functions', function() {
    ...
    it('should define extendProto method', function() {
        function TestObject() {
            this.property = 1;
        }
    ...
    it('should define createSubclass method', function() {
        function TestObject() { this.property = 1; };
        TestObject.prototype.method = throwError;
        TestObject.classMethod = throwError;
    ...
    it('should define makeSubclass function', function() {
        function TestObject() { this.property = 1; };
        TestObject.prototype.method = throwError;
        TestObject.classMethod = throwError;
    ...
    it('should define newApply function', function() {
